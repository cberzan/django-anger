...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'app_zeta.model14': {
            ...
            'field088': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'gsgfadasda'", 'null': 'True', 'to': "orm['app_lambda.Model25']"}),  # BAD: missing target model
            ...
            'field101': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'afsdggs'", 'null': 'True', 'to': "orm['app_lambda.Model25']"}),  # BAD: missing target model
