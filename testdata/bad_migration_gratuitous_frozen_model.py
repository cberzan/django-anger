...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'app_eta.model20': {  # BAD: gratuitous model
            'Meta': {'ordering': "('-qweo',)", 'object_name': 'Model20'},
            'field162': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'field163': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'field164': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'field165': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'qweo': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'})
        },
        'app_epsilon.model10': {
